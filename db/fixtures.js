...
function generateProductFixtures() {
    ...
    var testProducts = [
        ...
        {"type": "Product", "isActive": true, "name": "One-Time Purchase Product 1", "cycleType": "One-Time Purchase", vendor: "ACME Publishing", "oneTimePurchase": {}, license: "ACME License 1" },
        {"type": "Product", "isActive": true, "name": "One-Time Purchase Product 2", "cycleType": "One-Time Purchase", vendor: "ACME Publishing", "oneTimePurchase": {}, license: "ACME License 1"  },
        {"type": "Product", "isActive": true, "name": "One-Time Purchase Product 3", "cycleType": "One-Time Purchase", vendor: "ACME Publishing", "oneTimePurchase": {}, license: "ACME License 1"  },
        {"type": "Product", "isActive": true, "name": "One-Time Purchase Product 4", "cycleType": "One-Time Purchase", vendor: "ACME Publishing", "oneTimePurchase": {}, license: "ACME License 1"  },
