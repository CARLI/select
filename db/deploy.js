...
// Pretty sure this is old and busted...
// If this file is still in use, we will find out when things break and we see this error:
throw new Error("db/deploy.js: This file might be obsolete, but if you see this error it's not.");
// If it's still in use we should revert this error, but if we *don't* see this error during normal deployment and operation,
// then we should delete this file.
